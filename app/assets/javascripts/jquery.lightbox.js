...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'../images/common/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'../images/common/prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'../images/common/next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'../images/common/close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'../images/common/blank.gif',			// (string) Path and the name of a blank image (one pixel)
